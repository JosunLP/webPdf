...
<div class="pdf-toolbar">
  ...
  <div class="toolbar-section drawing-tools">
    ...
    <button 
      class="toolbar-tool-button" 
      class:active={drawingTool === DrawingTool.IMAGE}
    ...
    <button 
      class="toolbar-tool-button" 
      class:active={drawingTool === DrawingTool.TABLE}
      on:click={() => toggleDrawingTool(DrawingTool.TABLE)} 
      disabled={!pdfDocument}
    ...
    <!-- Unsichtbarer File-Input für Bilder -->
    <input
      type="file"
      id="imageFileInput"
      accept="image/*"
